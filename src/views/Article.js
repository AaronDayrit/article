            ...
            <div className="container">
                <div className="intro">
                    ...
                    <div className="icon-container">
                        <p><i class="fa-solid fa-gift"></i>Gift this article</p>
                        <i class="fa-solid fa-share"></i>
                        <i class="fa-solid fa-bookmark"></i>
                    </div>

                    <img src="https://www.econlib.org/wp-content/uploads/2018/04/Great-Depression.jpeg" />
                    <p class="caption">Image source: unplash.com</p>
                </div>

                <div className="profile-container">
                    <p className="name">By <span>Aaron Dayrit</span></p>
                    <p className="date">June 13, 2022</p>
                </div>
